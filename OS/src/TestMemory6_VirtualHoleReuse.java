public class TestMemory6_VirtualHoleReuse extends UserlandProcess{

    @Override
    public void main() {
        System.out.println("\n--- Test 6: Complex Virtual Hole Reuse ---");

        // Step 1️⃣: allocate several chunks (1–4 KB each)
        ...
        // Step 4️⃣: free another chunk and allocate bigger block to test merging
